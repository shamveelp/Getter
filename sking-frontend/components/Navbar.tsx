...
import { Search, User, ShoppingBag, House, Store, Mail } from "lucide-react";
...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <nav
                ref={desktopNavRef}
                className="hidden md:flex fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl rounded-full bg-black/40 backdrop-blur-xl border border-white/20 px-8 py-4 items-center justify-between shadow-[0_0_30px_0_rgba(255,255,255,0.1)] opacity-0"
            >
                {/* Brand Name */}
            ...
            >
                ...
                <button aria-label="Search" className="flex flex-col items-center gap-1 text-gray-300 hover:text-white transition-colors">
                    <Search size={22} />
                </button>
